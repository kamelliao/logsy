...
/** Called when the "jump to line" button is clicked. App installs this. */
let _onJump: ((n: number) => void) | null = null;
export function setPinnedLinesJumpHandler(fn: (n: number) => void) {
  _onJump = fn;
}
